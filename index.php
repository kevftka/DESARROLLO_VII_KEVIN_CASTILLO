...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-purple fixed-top">
        <a class="navbar-brand ml-5" href="http://localhost/my-food-recipe/index.php">Recetas PTY</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#food">Recetas</a>
                </li>
            </ul>   
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Bienvenido a Recetas PTY</strong></h1>
                            <p class="caption caption-p">Crea deliciosas recetas con facilidad utilizando nuestra aplicación web interactiva. Simplemente ingrese los platos que desea cocinar, junto con sus ingredientes correspondientes y los procedimientos paso a paso, para garantizar una experiencia culinaria deliciosa y perfecta.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="image/bg3.jpg" class="d-block w-100" alt="...">d
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>¿Es cansado comer lo mismo todos los dias verdad?</strong></h5>
                            <p class="caption caption-p">¡Se parte de nuestra comunidad y prepara lo que se te antoje!</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="image/bg5.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>¡Ahora no solo prepararas tus recetas, tambien podras plantar tus condimentos!</strong></h1>
                            <p class="caption caption-p">Pronto...</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title text-center"><strong>Lista de ingredientes </strong></h4>
                                <p class="card-text text-center">Informacion detallada sobre ue cantidad de cada ingrediente debe usar</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title text-center"><strong>Lista de comidas</strong></h4>
                                <p class="card-text text-center">Aqui encontraras todas las opciones que tenemos para que prepares</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title text-center"><strong>procedimientos</strong></h4>
                                <p class="card-text text-center">Aqui encontraras los pasos enumerados y en orden </p>
                            </div>
                        </div>
                    </div>
                </div>   
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Desayunos</strong></h5>
                            <a class="btn btn-dark btn-block" data-toggle="modal" data-target="#breakfastModal">Ver Lista</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Almuerzos</strong></h5>
                            <a class="btn btn-dark btn-block" data-toggle="modal" data-target="#lunchModal">Ver Lista</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Cenas</strong></h5>
                            <a class="btn btn-dark btn-block" data-toggle="modal" data-target="#dinnerModal">Ver Lista</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Aperitivos</strong></h5>
                            <a class="btn btn-dark btn-block" data-toggle="modal" data-target="#appetizerModal">Ver Lista</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Postres</strong></h5>
                            <a class="btn btn-dark btn-block" data-toggle="modal" data-target="#dessertModal">Ver Lista</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Comida rapida</strong></h5>
                            <a class="btn btn-dark btn-block" data-toggle="modal" data-target="#fastFoodModal">Ver Lista</a>
                        </div>
                    </div>
                </div>
            </div>   
    ...
    <section id="food">
        <div class="card card-food-list">
            <h1 class="text-center"><strong>Lista de comidas</strong></h1>
            <div class="mt-4">
                <div class="row">
